...
{
    /// <inheritdoc />
    public partial class InitialUsersAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    member_since_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    average_rating = table.Column<decimal>(type: "numeric(3,2)", nullable: true),
                    completed_trip_count = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_phone_verification_codes_user_id_used_at_utc",
                table: "phone_verification_codes",
                columns: new[] { "user_id", "used_at_utc" });
